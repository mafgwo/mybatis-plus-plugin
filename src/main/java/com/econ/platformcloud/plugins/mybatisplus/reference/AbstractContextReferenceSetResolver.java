 ...
 * @author yanglin
 */
public abstract class AbstractContextReferenceSetResolver<F extends PsiElement, K extends PsiElement> {
    ...
    protected AbstractContextReferenceSetResolver(@NotNull F element) {
